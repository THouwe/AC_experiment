...
////////////////////////////////////////////////////////////////////////////////
  ...
  var welcome = {
    ...
    preamble: "<p>Herzlich Willkommen zur Experiments!</p>" +
    "<p> </p>" +
    "<p>In order to make data anonymus, please insert below the initials of your parents in capital letters without spaces.</p>" +
    "<p> </p>",
    html: "<p>Parents initials: <input name='Part_ID' type='text' /></p>",
  ...
  var instructions_general = {
    data: {
      screen_ID: "Instructions_general"
    },
    type: "instructions",
    pages: [
      // instr page 1:
      "<p>ALLGEMEINE ANWEISUNGEN:</p>" +
      "<p> </p>" +
      "<p> </p>" +
      "<p>In diesem Experiment geht es um Spracherkennung.</p>" +
      "<p>Sie hören Wörter über Kopfhörer und sprechen sie über das Mikrofon des Laptops aus.</p>" +
      "<p>The experiment lasts about 45 minutes and is compensated with either 15.- CHF or 1 Versuchpersonstunde (VPS).</p>" +
      "<p>Instructions on how to collect the compensation are provided upon study completion.</p>" +
      "<p>Auf den nächsten Seiten werden wir sicherstellen, dass die Voraussetzungen für einen reibungslosen Ablauf des Experiments erfüllt sind.</p>",
      // instr page 2:
      "<p>Stelle sicher, dass du dich in einer ruhigen Umgebung befindest.</p>" +
      ...
      // instr page 3:
      "<p>Bitte trage Kopfhörer und mache es dir bequem.</p>" +
      ...
      // instr page 4:
      "<p>Wenn Sie keinen Kopfhörer haben oder sich nicht in einer ruhigen Umgebung befinden, " +
      "schließen Sie diese Seite und starten Sie das Experiment neu, wenn Sie sich in diesem Zustand befinden.</p>",
      // instr page 5:
      "<p>Schließlich, bevor du mit dem Experiment beginnen kannst, musst du die Lautstärke einstellen.</p>" +
      "<p>Dazu hörst du auf der nächsten Seite ein Stimmengewirr.</p>" +
      "<p>Stelle die Lautstärke so ein, dass sie dir angenehm ist und du die Geräusche gut hörst.</p>"
    ],
  ...
  var calib_preAudio = {
    ...
    stimulus: "<p>AUFGABE 1/4: KALIBRIERUNG</p>",
    choices: ["Abspielen"]
  };
  ...
  var calib_audioOut = {
    ...
    prompt: "Stelle die Lautstärke so ein, dass sie dir angenehm ist und du die Geräusche gut hörst.",
  response_ends_trial: false
  }

  var calib_postAudio = {
    type: 'html-button-response',
    stimulus: "<p>Wenn du die Lautstärke eingestellt hast, fahre fort zum Experiment.</p>" +
    "<p>Falls nicht, spiele das Stimmengewirr erneut ab.</p>",
...
///////////////////
  ...
  var instructions_TT = {
    type: 'instructions',
    data: {
      screen_ID: "instructions_TT"
    },
    pages: ["<p>AUFGABE 2/4: ZUNGENBRECHER</p>" +
    "<p>As part of this test, you will be asked to repeat out loud a four-word tongue twister.</p>" +
    "<p>To this end, a pop-out window will soon ask you to allow the browser access to the computer microphone.</p>" +
    "<p>Wenn Sie Mozilla Firefox verwenden, klicken Sie auf «Diese Entscheidung merken», bevor Sie auf «Zulassen» klicken (linkes Bild).</p>" +
    "Wenn Sie Google Chrome verwenden, klicken Sie einfach auf «Zulassen» (rechtes Bild).</p>" +
    ...
    //
    "<p>Sobald Sie die Taste «Trainingsdurchgang starten» drücken, hören Sie ein (langsames) Metronom.</p>" +
    "<p>Nun kannst du die eingeblendeten Wörter im Takt des Metronoms vor dich hersagen.</p>" +
    "<p>Nachdem Sie die vier Wörter einmal wiederholt haben, können Sie mit der eigentlichen Aufnahme beginnen, " +
    "indem Sie auf die Schaltfläche «Trainingsdurchgang beenden und Aufnahme starten» klicken.</p>" +
    "<p>Sie werden wieder ein Metronom hören, aber dieses Mal wird es einen schnelleren Rhythmus spielen.</p>" +
    "<p>Bitte warten Sie mindestens vier Schläge und wiederholen Sie die vier angezeigten Wörter DREI MAL IN EINER REIHE, ohne die Zeit mit dem Mikrofon zu unterbrechen.</p>" +
    "<p>Wenn Sie fertig sind, warten Sie mindestens vier Schläge und klicken Sie auf die Schaltfläche «Aufnahme beenden».</p>"
    ],
    show_clickable_nav: true,
    button_label_previous: "Zurück",
    button_label_next: "Fortfahren"
  ...
  // TT_timeline.timeline = [instructions_TT, randomizedTTblocks];
  // TT_timeline.timeline = [instructions_TT, TTtest_procedure_blockA];
...
////////////////////////////////////////////////////////////////////////////////
  var instructions_DS = {
    ...
    type: 'instructions',
    pages: [
      "<p>AUFGABE 3/4: DIGIT SPAN</p>" +
      "<p>In diesem Aufgabe hören Sie eine Reihe von Zahlen und werden aufgefordert, " +
      ...
      "<p>Drücken Sie die Taste unten, um mit dem ersten Teil fortzufahren.</p>"
    ],
  ...
  var instructions_FWDS = {
    ...
    type: 'html-button-response',
    stimulus: "<p>In diesem ersten Teil besteht Ihre Aufgabe darin, die Reihenfolge der Zahlen in der Reihenfolge der Präsentation anzugeben " +
  ...
  var trial2_FWDS_resp = {
    ...
    type: 'survey-text',
    questions: [
      {prompt: 'Gebe die Nummern in der Reihenfolge an, in der du sie gehört hast.',  columns: 12}
    ],
    button_label: 'Antwort eingeben',
    on_finish: function(data){
        data.response_given = jsPsych.data.getLastTrialData().values()[0].responses[7] +
...
var instructions_BWDS = {
  ...
  type: 'html-button-response',
  stimulus: "<p>Dieser Teil ist abgeschlossen, danke!</p>" +
  "<p> </p>" +
  "<p> </p>" +
  "<p>Im nächsten Teil besteht Ihre Aufgabe darin, die Reihenfolge der Zahlen in der Reihenfolge der UMGEKEHRTEN Darstellung anzugeben " +
...
var trial1_BWDS_resp = {
  ...
  type: 'survey-text',
  questions: [
    {prompt: 'Gebe die Nummern IN DER UMGEKEHRTEN REIHEINFOLGE AN, als in der du sie gehört hast.',  columns: 12}
  ],
  button_label: 'Antwort eingeben',
  on_finish: function(data){
      data.response_given = jsPsych.data.getLastTrialData().values()[0].responses[7] +
...
////////////////////////////////////////////////////////////////////////////////
  var instructions_wordRec = {
    ...
    pages: [
      ...
      "dass du das Wort wiederholen musst.</p>",
...
// }
  ...
  var stimDir_SiNwords_list2 = "../../stimuli/wordRec/SiN/0dB_SNR/List2/";

  var start_wordRecSiN = {
    data: {screen_id: "start_wordRecSiN"},
    type: 'html-button-response',
    stimulus: "<p>In diesem Teil werden Sie aufgefordert, Worten zu identifizieren, " +
    "die in Hintergrundgeräusche eingebettet sind.</p>" +
    "<p> </p>" +
    "<p> </p>"  +
  ...
  var stimuli_list1SiN = [
    ...
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Bleistift.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Bleistift"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Dusche.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Dusche"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Handschuh.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Handschuh"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Haut.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Haut"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Hose.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Hose"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Kittel.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Kittel"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Knochen.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Knochen"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Lunge.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Lunge"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Ofen.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Ofen"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Palme.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Palme"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Panther.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Panther"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Papier.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Papier"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Pasta.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Pasta"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Rauch.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Rauch"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Rohr.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Rohr"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Schwan.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Schwan"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Sofa.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Sofa"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Sonnenbrille.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Sonnenbrille"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Stift.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Stift"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Taille.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Taille"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Wagen.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Wagen"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Zeitung.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Zeitung"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Zoo.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Zoo"}},
    {stimulus_list1SiN: stimDir_SiNwords_list2 + "Zwiebel.wav", data_list1SiN: {screen_id: audioOut_list1SiN, nrNvChan:5, word_id: "Zwiebel"}}
...
// }
  ...
  var stimDir_NVSwords_list2 = "../../stimuli/wordRec/NVS/5chan/List2/";

  var start_wordRecNVS = {
    data: {screen_id: "start_wordRecNVS"},
    type: 'html-button-response',
    stimulus: "<p>In diesem Teil werden Sie aufgefordert, Worten zu identifizieren, " +
    "die mit Rauschen gemischt sind.</p>" +
    "<p> </p>" +
    "<p> </p>"  +
    "<p>Drücken Sie die Taste unten, um das Teil zu starten.</p>",
    choices: ['Teil starten'] //,
  ...
  var stimuli_list1NVS = [
    ...
    {stimulus_list1NVS: stimDir_NVSwords_list1 + "Hoele.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Hoele"}},
    {stimulus_list1NVS: stimDir_NVSwords_list1 + "Koffer.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Koffer"}},
    {stimulus_list1NVS: stimDir_NVSwords_list1 + "Kostuem.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Kostuem"}},
    {stimulus_list1NVS: stimDir_NVSwords_list1 + "Loewe.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Loewe"}},
    ...
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Ballon.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Ballon"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Bett.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Bett"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Eimer.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Eimer"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Eule.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Eule"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Fernsehen.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Fernsehen"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Gehirn.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Gehirn"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Haehnchen.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Haehnchen"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Hai.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Hai"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Hand.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Hand"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Hirsch.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Hirsch"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Hut.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Hut"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Kiefer.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Kiefer"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Markt.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Markt"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Messer.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Messer"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Mixer.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Mixer"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Musik.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Musik"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Ohrring.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Ohrring"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Pfeil.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Pfeil"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Sandale.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Sandale"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Spiegel.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Spiegel"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Stiefel.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Stiefel"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Taube.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Taube"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Taxi.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Taxi"}},
    {stimulus_list1NVS: stimDir_NVSwords_list2 + "Teppich.wav", data_list1NVS: {screen_id: audioOut_list1NVS, nrNvChan:5, word_id: "Teppich"}}
  ];
...
function startExp() {
  ...
  var audioFiles = [
    ...
    stimDir_SiNwords_list1 + "Ei.wav",
    stimDir_SiNwords_list1 + "Erdbeere.wav",
    stimDir_SiNwords_list1 + "Film.wav",
    stimDir_SiNwords_list1 + "Fisch.wav",
    stimDir_SiNwords_list1 + "Gewebe.wav",
    stimDir_SiNwords_list1 + "Hammer.wav",
    stimDir_SiNwords_list1 + "Hemd.wav",
    stimDir_SiNwords_list1 + "Hotel.wav",
    stimDir_SiNwords_list1 + "Kabine.wav",
    stimDir_SiNwords_list1 + "Kasino.wav",
    stimDir_SiNwords_list1 + "Luft.wav",
    stimDir_SiNwords_list1 + "Nudel.wav",
    stimDir_SiNwords_list1 + "Park.wav",
    stimDir_SiNwords_list1 + "Pferd.wav",
    stimDir_SiNwords_list1 + "Radio.wav",
    stimDir_SiNwords_list1 + "Rahmen.wav",
    stimDir_SiNwords_list1 + "Schulter.wav",
    stimDir_SiNwords_list1 + "Tankstelle.wav",
    stimDir_SiNwords_list1 + "Tempel.wav",
    stimDir_SiNwords_list1 + "Treppe.wav",
    stimDir_SiNwords_list1 + "Wal.wav",
    stimDir_SiNwords_list2 + "Bleistift.wav",
    stimDir_SiNwords_list2 + "Dusche.wav",
    stimDir_SiNwords_list2 + "Handschuh.wav",
    stimDir_SiNwords_list2 + "Haut.wav",
    stimDir_SiNwords_list2 + "Hose.wav",
    stimDir_SiNwords_list2 + "Kittel.wav",
    stimDir_SiNwords_list2 + "Knochen.wav",
    stimDir_SiNwords_list2 + "Lunge.wav",
    stimDir_SiNwords_list2 + "Ofen.wav",
    stimDir_SiNwords_list2 + "Palme.wav",
    stimDir_SiNwords_list2 + "Panther.wav",
    stimDir_SiNwords_list2 + "Papier.wav",
    stimDir_SiNwords_list2 + "Pasta.wav",
    stimDir_SiNwords_list2 + "Rauch.wav",
    stimDir_SiNwords_list2 + "Rohr.wav",
    stimDir_SiNwords_list2 + "Schwan.wav",
    stimDir_SiNwords_list2 + "Sofa.wav",
    stimDir_SiNwords_list2 + "Sonnenbrille.wav",
    stimDir_SiNwords_list2 + "Stift.wav",
    stimDir_SiNwords_list2 + "Taille.wav",
    stimDir_SiNwords_list2 + "Wagen.wav",
    stimDir_SiNwords_list2 + "Zeitung.wav",
    stimDir_SiNwords_list2 + "Zoo.wav",
    stimDir_SiNwords_list2 + "Zwiebel.wav",
    stimDir_NVSwords_list1 + "Bank.wav",
    stimDir_NVSwords_list1 + "Baum.wav",
    stimDir_NVSwords_list1 + "Birne.wav",
    stimDir_NVSwords_list1 + "Blume.wav",
    stimDir_NVSwords_list1 + "Brille.wav",
    stimDir_NVSwords_list1 + "Flugzeug.wav",
    stimDir_NVSwords_list1 + "Geschenk.wav",
    stimDir_NVSwords_list1 + "Handgelenk.wav",
    stimDir_NVSwords_list1 + "Hase.wav",
    stimDir_NVSwords_list1 + "Hoele.wav",
    stimDir_NVSwords_list1 + "Koffer.wav",
    stimDir_NVSwords_list1 + "Kostuem.wav",
    stimDir_NVSwords_list1 + "Loewe.wav",
    stimDir_NVSwords_list1 + "Pflanze.wav",
    stimDir_NVSwords_list1 + "Restaurant.wav",
    stimDir_NVSwords_list1 + "Salz.wav",
    stimDir_NVSwords_list1 + "Schere.wav",
    stimDir_NVSwords_list1 + "Suppe.wav",
    stimDir_NVSwords_list1 + "Tablette.wav",
    stimDir_NVSwords_list1 + "Telefon.wav",
    stimDir_NVSwords_list1 + "Uhr.wav",
    stimDir_NVSwords_list1 + "Villa.wav",
    stimDir_NVSwords_list1 + "Weste.wav",
    stimDir_NVSwords_list1 + "Ziege.wav",
    stimDir_NVSwords_list2 + "Ballon.wav",
    stimDir_NVSwords_list2 + "Bett.wav",
    stimDir_NVSwords_list2 + "Eimer.wav",
    stimDir_NVSwords_list2 + "Eule.wav",
    stimDir_NVSwords_list2 + "Fernsehen.wav",
    stimDir_NVSwords_list2 + "Gehirn.wav",
    stimDir_NVSwords_list2 + "Haehnchen.wav",
    stimDir_NVSwords_list2 + "Hai.wav",
    stimDir_NVSwords_list2 + "Hand.wav",
    stimDir_NVSwords_list2 + "Hirsch.wav",
    stimDir_NVSwords_list2 + "Hut.wav",
    stimDir_NVSwords_list2 + "Kiefer.wav",
    stimDir_NVSwords_list2 + "Markt.wav",
    stimDir_NVSwords_list2 + "Messer.wav",
    stimDir_NVSwords_list2 + "Mixer.wav",
    stimDir_NVSwords_list2 + "Musik.wav",
    stimDir_NVSwords_list2 + "Ohrring.wav",
    stimDir_NVSwords_list2 + "Pfeil.wav",
    stimDir_NVSwords_list2 + "Sandale.wav",
    stimDir_NVSwords_list2 + "Spiegel.wav",
    stimDir_NVSwords_list2 + "Stiefel.wav",
    stimDir_NVSwords_list2 + "Taube.wav",
    stimDir_NVSwords_list2 + "Taxi.wav",
    stimDir_NVSwords_list2 + "Teppich.wav"
];
  ...
  jsPsych.init({
   ...
   timeline: [calib_timeline, instructions_TT, TT_timeline, FWDS_timeline, BWDS_timeline, instructions_wordRec, wordRec_timeline],
    use_webaudio: true,
    // use_webaudio: true,
